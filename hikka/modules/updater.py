...
class UpdaterMod(loader.Module):
    ...
    strings = {
        "name": "Updater",
        "source": soso + "<b>Soso manzili quyida joylashgan</b> <a href='{}'>bu yerda</a>",
        "restarting_caption": soso + "<b>Qayta ishga tushirilmoqda...</b>",
        "downloading": soso + "<b>Yangilanishlar yuklab olinmoqda...</b>",
        "installing": soso + "<b>Installing updates...</b>",
        "success": soso + "<b>Qayta ishga tushirish muvaffaqiyatli! {}</b>\n<i>Ammo modullar hali ham yuklanmoqda...</i>\n<i>Qayta ishga tushirish {} soniya</i>",
        "origin_cfg_doc": "Qayerdan yangilash uchun Git Origin URL",
        "btn_restart": soso + "Qayta ishga tushirish",
        "btn_update": soso + "Yangilash",
        "restart_confirm": sosob + "<b>Are you sure you want to restart?</b>",
        "update_confirm": (
            "<b>Siz yangilashni hoxlaysizmi?\n\n"
            '<a href="https://github.com/hikariatama/Hikka/commit/{}">{}</a> ⤑ '
            '<a href="https://github.com/hikariatama/Hikka/commit/{}">{}</a></b>'
        ),
        "no_update": soso + "<b>Sizda oxirgi talqin, lekin shundayam yangilashni hoxlaysizmi?</b>",
        "cancel": soso + "Bekor qilish",
        "lavhost_restart": soso + "<b>Your lavHost is restarting...\n&gt;///&lt;</b>",
        "lavhost_update": soso + "<b>Your lavHost is updating...\n&gt;///&lt;</b>",
        "heroku_update": soso + "<b>Deploying new version to Heroku...\nThis might take some time</b>",
        "full_success": soso + "<b>Soso to'liq yuklandi! {}</b><a href='{}'></a>",
        "heroku_psycopg2_unavailable": soso + "<b>PostgreSQL database is not available.</b>\n\n<i>Do not report this error to support chat, as it has nothing to do with Hikka. Try changing database to Redis</i>",
    }

    strings_ru = {
        "source": soso + "<b>Исходный код можно прочитать</b> <a href='{}'>здесь</a>",
        "restarting_caption": soso + "<b>Перезагрузка...</b>",
        "downloading": soso + "<b>Скачивание обновлений...</b>",
        "installing": soso + "<b>Установка обновлений...</b>",
        "success": soso + "<b>Перезагрузка успешна! {}</b>\n<i>Но модули еще загружаются...</i>\n<i>Перезагрузка заняла {} сек</i>",
        "full_success": soso + "<b>Юзербот полностью загружен! {}</b><a href='{}'></a>",
        "origin_cfg_doc": "Ссылка, из которой будут загружаться обновления",
        "btn_restart": soso + "Перезагрузиться",
        "btn_update": soso + "Обновиться",
        "restart_confirm": soso + "<b>Ты уверен, что хочешь перезагрузиться?</b>",
        "update_confirm": (
            "<b>Ты уверен, что хочешь обновиться??\n\n"
            '<a href="https://github.com/hikariatama/Hikka/commit/{}">{}</a> ⤑ '
            '<a href="https://github.com/hikariatama/Hikka/commit/{}">{}</a></b>'
        ),
        "no_update": soso + "<b>У тебя последняя версия. Обновиться принудительно?</b>",
        "cancel": soso + "Отмена",
        ...
        "lavhost_restart": soso + "<b>Твой lavHost перезагружается...\n&gt;///&lt;</b>",
        "lavhost_update": soso + "<b>Твой lavHost обновляется...\n&gt;///&lt;</b>",
        "heroku_update": soso + "<b>Обновляю Heroku...</b>",
    ...
    def __init__(self):
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                "GIT_ORIGIN_URL",
                "https://github.com/onnewona/onne",
